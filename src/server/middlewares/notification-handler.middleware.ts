...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  ...
  'project.update.update': { roles: ['owner', 'admin'], key: 'project', tenantPath: [], userPath: [] },
  'comment.create.create': { roles: ['owner', 'admin', 'team-member'], key: 'comment', tenantPath: [], userPath: [] },
};
