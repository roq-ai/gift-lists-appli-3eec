...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Gift Lists Application`}</title>

        <meta
          name="description"
          content="Welcome to Gift Lists Application - Your ultimate platform for creating, managing, and sharing your gift lists with ease and efficiency."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1513201099705-a9746e1e201f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxnaWZ0fGVufDB8fHx8MTY5NTk5MzY5MHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`Gift Lists Application`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Gift Lists Application - Your ultimate platform for creating, managing, and sharing your gift lists with ease and efficiency.`}
            </Text>
            <Box
