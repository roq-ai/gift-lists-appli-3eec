...
import { FiMail, FiUsers, FiMenu, FiUser, FiMessageCircle, FiFile, FiBox, FiList, FiGift } from 'react-icons/fi';
...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Gift Items', path: '/gift-items', entity: 'gift_item', service: AccessServiceEnum.PROJECT, icon: FiBox },
    { name: 'Gift Lists', path: '/gift-lists', entity: 'gift_list', service: AccessServiceEnum.PROJECT, icon: FiList },
    {
      name: 'Team Gift Lists',
      path: '/team-gift-lists',
